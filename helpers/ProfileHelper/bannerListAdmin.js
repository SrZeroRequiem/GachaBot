...
async function bannerList(id, interaction, reply) {
    if (embedBanner.length === 0) {
        ...
        for (let a = 0; a < waifuList.length; ++a) {
            ...
            if (waifuList[a].stars == 5) {
                ...
                footer = "💫💫💫💫💫💫"
            } else if (waifuList[a].stars == 7) {
                footer = "💫💫💫💫💫💫💫"
            } else if (waifuList[a].stars == 8){
                footer = "🌸🌸🌸🌸🌸🌸🌸"
            } else {
                footer = "¿⭐?"
            }
    ...
    if (interaction.values) {
        if (interaction.values[0] === 'first_option') {
            ...
            optionsBanner[id] = 5
            pagesBanner[id] = 0
        } else if (interaction.values[0] === 'six_starsB') {
            await interaction.deferUpdate()
            optionsBanner[id] = 6
            pagesBanner[id] = 0
        ...
        if (interaction.values[0] === 'no_starsB' || interaction.values[0] === 'four_starsB' || interaction.values[0] === 'five_starsB' || interaction.values[0] === 'first_option'|| interaction.values[0] === 'six_starsB' ) {
