...
async function getArray() {
    ...
    try {
        ...
        tiradas = await usersdb.find({
            stars : {$lt: 9},
            anime : {$in: ["Go-Toubun no Hanayome","Komi-san wa, Komyushou desu","Paripi Koumei","Kawaii dake ja Nai Shikimori-san","Love After World Domination","Spy x Family","Eight Six","Shoujo☆Kageki Revue Starlight",
